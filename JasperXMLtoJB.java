...
public class JasperXMLtoJB {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args[0] == null) {
			System.out.println("ERRO: Necessita de passar o arquivo .jrxml por parâmetro");
			return;
		}

		/* Verifica se o nome da classe foi passada por parametro */
		if (args[1] == null) {
			System.out.println("ERRO: Necessita de passar o nome da classe por parâmetro");
			return;
		}

		/* Verifica se o arquivo passado é JRXML */
		if (!args[0].substring(args[0].length() - 6, args[0].length()).equals(".jrxml")) {
			System.out.println("ERRO: Arquivo não é JRXML");
			return;
		}
